...
https://t.me/NatureProtocol
https://natureprotocol.io
...
contract NatureProtocol is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Nature Protocol", "NATURE") {
        ...
        maxSellAmount = totalSupply * 2 / 100; // 1% maxSellAmount
        ...
        marketingWallet = address(0x7B6c7a51CD925958bfCc86A2E68906A8d3312A67);
        developmentWallet = address(0xa81689df0D6E0FA46Ab767D1c35D22556A34854F);
    ...
    function swapTokensForEth(address recepient, uint256 tAmount) private {
    ...
    function swapBack(address recepient) private {
        ...
        swapTokensForEth(recepient, amountToSwapForETH); 
    ...
    function withdrawStuckEth() external returns (bool success) {
